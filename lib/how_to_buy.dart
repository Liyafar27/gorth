...
class HowToBuySection extends StatefulWidget {
  ...
  'desc': 'Complete the swap, then join [Telegram](https://t.me/OG_Gorth_Solana) and [X](https://x.com/i/communities/1923786151607091641).'
  },
  ];
  ...
  Icon(
  expanded[i] ? Icons.keyboard_arrow_up : Icons.keyboard_arrow_down,
  color: accent,
  ),
  ],
  ),
